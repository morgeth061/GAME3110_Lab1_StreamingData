...
static public class AssignmentPart1
{
    ...
    static public void LoadPartyButtonPressed()
    {
        ...
        while ((line = sr.ReadLine()) != null)
        {
            ...
            {
                PartyCharacter pc = new PartyCharacter(int.Parse(csv[0]),
                int.Parse(csv[1]),
                int.Parse(csv[2]),
                int.Parse(csv[3]),
                int.Parse(csv[4]),
            ...
            { 
                GameContent.partyCharacters.Last.Value
            } */
                


            GameContent.partyCharacters.AddLast(new PartyCharacter(int.Parse(csv[0]), 
                int.Parse(csv[1]), 
                int.Parse(csv[2]), 
                int.Parse(csv[3]), 
                int.Parse(csv[4]), 
        ...
        //GameContent.partyCharacters.AddLast(new PartyCharacter(0, 0, 0, 0, 0, 0));
...
//We should make a system to save an incrementing number

// ability to save a line of text
//
//Write character values to .txt
//
//How are we supporting party size
//
//Equipment
//
//Reload UI with new content
//
